...
if __name__ == '__main__':
    ...
    times = [5.0]
    boards = [
        r"C:/Users/Yosar/Desktop/2AMU10_Assigment_team05-main/competitive_sudoku/boards/empty-3x3.txt"
    ]
    players = [("team05_A1_Copy", "greedy_player"), ("greedy_player", "team05_A1_Copy")]
    output_file = "simulation_results/simulation_summary_A1_copy_vs_greedy.txt"
